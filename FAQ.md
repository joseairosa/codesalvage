...
- [What is the escrow period?](#what-is-the-escrow-period)
- [Can I see the code before buying?](#can-i-see-the-code-before-buying)
- [What if the code doesn't work?](#what-if-the-code-doesnt-work)
...
- [What completion percentage should I use?](#what-completion-percentage-should-i-use)
- [Can I sell the same project to multiple buyers?](#can-i-sell-the-same-project-to-multiple-buyers)
...
- [Can I use purchased code commercially?](#can-i-use-purchased-code-commercially)
...
- Students learning from real-world codebases
- Agencies exploring new tech stacks
...
1. **Browse**: Search for projects by tech stack, price, completion %
2. **Evaluate**: Read descriptions, view screenshots, check seller ratings
3. **Purchase**: Secure checkout via Stripe
4. **Download**: Receive code immediately (ZIP or GitHub access)
...
4. **Get Paid**: Receive funds after escrow period ends
...
**Important**: Completion % tells you how much is done. If a project is 70% complete, you'll need to finish the remaining 30% yourself.

---

### How do I know if a project is good quality?
...
- Detailed description including known issues
- High-quality screenshots or demo video
- Public GitHub repository (preview code quality)
- Live demo available
...
- Price way below similar projects
- No response to pre-purchase messages
- Completion % seems inflated vs. description

**Best Practice**: Message seller with technical questions before purchasing. Responsive, knowledgeable answers = quality seller.
...
- Valid reasons for refund:
  - ✅ Project significantly incomplete vs. description
...
- ❌ You want a different tech stack (that was disclosed)
...
4. Funds returned to original payment method if approved
...
4. You have **7 days** to review and test code
...
- Open dispute if issues found (do this EARLY, not on day 7)
...
### Can I resell a project I purchase?

**Check the license type** specified by seller.

**Common License Types**:

1. **Full Code Transfer** (most common)
   - You own all rights after purchase
   - ✅ Can use commercially
   - ✅ Can modify
   - ✅ Can resell
   - ✅ Can integrate into your products

2. **Limited License**
   - You can use but cannot resell as-is
   - ✅ Can use commercially
   - ✅ Can modify
   - ❌ Cannot resell original code
   - ✅ Can sell derivative products built on top

3. **Custom License**
   - Read seller's specific terms
   - Varies by project

**Best Practice**: Clarify licensing with seller before purchasing if you plan to resell.
...
- **10-30%**: Basic structure and core features started
  - Example: Authentication framework set up, few pages completed

- **30-50%**: Core features working, many supporting features missing
  - Example: User management works, but dashboard and reporting not started

- **50-70%**: Most major features present, needs refinement and polish
  - Example: All CRUD operations work, but UI needs work and tests missing

- **70-90%**: Feature-complete, needs testing, bug fixes, and finishing touches
  - Example: All features built, minor bugs present, documentation incomplete

- **90-100%**: Nearly complete, only minor fixes or deployment remaining
...
- Tests (test coverage adds to completion)
...
### Can I sell the same project to multiple buyers?
...
2. **You Respond** (within 24-48 hours)
   - Provide counter-evidence
   - Screenshots, original listing description, messages
   - Explain your side professionally

3. **Platform Reviews** (2-3 business days)
   - We review both sides
   - Check: Description accuracy, code quality, evidence
   - Decision: Full refund, partial refund, or no refund

4. **Decision Final**
   - Both parties notified
   - Funds released or refunded based on decision
   - Outcome affects seller rating if refund issued
...
2. **Verified Pro Badge** ✅
   - Shield badge on your profile and listings
   - Builds buyer trust
   - Increases conversion rates

3. **Featured Listing Discounts**
   - 20% off all featured placements
   - Example: $129 → $103 for 1-month featured
...
- Featured listing discounts no longer available
...
- Typically 10-100MB
- Valid for 30 days (re-download anytime)
...
- ✅ Documentation (README, if provided)
- ❌ Environment secrets (API keys - you must provide your own)
...
### Who owns the code after purchase?
...
- ✅ You can sell products built on top
...
- All partners are GDPR/CCPA compliant

**Read Full Privacy Policy**: `/privacy`

---

### Can I use purchased code commercially?
...
- **Seller Guide**: Comprehensive guide for selling projects
- **Buyer Guide**: Complete guide for purchasing and using projects
- **Terms of Service**: Legal terms and conditions
- **Privacy Policy**: How we handle your data

### Community (Coming Soon)

- **Discord Server**: Ask questions, share tips, network
- **Blog**: Tutorials, case studies, platform updates
