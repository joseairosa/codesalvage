...
- **"Seller"**: A user who lists unfinished code projects for sale on the Platform.
- **"Buyer"**: A user who purchases code projects from Sellers.
...
- Not misrepresent the state of Projects
...
- Selling the same Project as "exclusive" to multiple Buyers without disclosure
- Contacting Buyers outside the Platform to circumvent fees
...
- Leaving false or misleading reviews
...
- Not contain malicious code, viruses, or security vulnerabilities
...
- **Free Tier**: Maximum 3 active Project listings
- **Pro Tier** ($9.99/month): Unlimited active listings
...
Sellers set their own prices in USD. All prices are displayed in USD and charged in USD.
...
Payments are processed via Stripe. By making a purchase, you agree to Stripe's Terms of Service and Privacy Policy.
...
4. If no dispute, payment releases to Seller after 7 days
...
- Code files are missing or corrupted
...
- Disputes opened after 7-day Escrow Period

### 7.3 Dispute Process

1. **Open Dispute**: Buyer opens dispute within 7 days with evidence
2. **Seller Response**: Seller has 48 hours to respond with counter-evidence
3. **Platform Review**: We review both sides within 2-3 business days
4. **Decision**: Full refund, partial refund, or no refund
5. **Final**: Decision is final and binding
...
- Comparison of advertised vs. actual functionality

---

## 8. Code Delivery and Licensing
...
**Download Availability**: 30 days after purchase. Download as many times as needed within this period.
...
Only verified Buyers who completed a Transaction may leave reviews.
...
- Not be incentivized (no reviews in exchange for compensation)
...
- Post reviews containing personal information of others
...
- Cancel anytime (benefits end at end of billing period)
- No refunds for partial months
- Price subject to change with 30 days notice
...
- Project limit reverts to 3 active listings upon cancellation
...
- 1 Week: $49 ($39 for Pro members)
- 2 Weeks: $79 ($63 for Pro members)
- 1 Month: $129 ($103 for Pro members)
...
- Featured period starts immediately upon purchase
- No refunds for featured listings (purchased slots are non-refundable)
- Projects must meet quality standards to remain featured
...
We collect and process personal data as described in our [Privacy Policy](PRIVACY_POLICY.md). By using the Platform, you consent to data collection and processing.
...
- That Projects are free from bugs, errors, or security vulnerabilities
...
- Security vulnerabilities in purchased code are not our responsibility
...
- Transactions you engage in on the Platform
...
- Required by law
- You engage in conduct harmful to other users or the Platform
...
YOU AGREE TO BRING CLAIMS ONLY ON AN INDIVIDUAL BASIS. YOU WAIVE THE RIGHT TO PARTICIPATE IN CLASS ACTIONS, CLASS ARBITRATIONS, OR REPRESENTATIVE ACTIONS.
...
We are not liable for failure to perform due to causes beyond our reasonable control (natural disasters, war, strikes, internet outages, etc.).
