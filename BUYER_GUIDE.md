...
1. [Getting Started as a Buyer](#getting-started-as-a-buyer)
2. [Finding the Right Project](#finding-the-right-project)
3. [Evaluating Projects](#evaluating-projects)
4. [Purchasing a Project](#purchasing-a-project)
5. [After Purchase](#after-purchase)
6. [Understanding Escrow](#understanding-escrow)
7. [Leaving Reviews](#leaving-reviews)
8. [Managing Your Purchases](#managing-your-purchases)
9. [Messaging Sellers](#messaging-sellers)
...
2. **Complete Your Profile** (Optional)
   - Add a bio if you want sellers to know more about you
   - Your GitHub username and avatar are used by default
   - Profile is visible to sellers when you message them

3. **Start Browsing**
   - No verification needed to browse projects
   - Payment information only required at checkout
   - Save favorites to track interesting projects
...
- **Newest**: Recently listed projects (default)
- **Price: Low to High**: Budget-friendly first
- **Price: High to Low**: Premium projects first
- **Completion: High to Low**: Nearly finished first
- **Trending**: Most views and favorites recently
...
3. Receive notifications (coming soon):
   - Price drops
   - Updates to favorited projects
   - Similar projects listed
...
- Look for:
  ...
  - Completeness of features shown
...
- Seller has no reviews and low rating
- Price significantly lower than similar projects (too good to be true?)
- No response to your messages within 48 hours
...
- Pro verified seller badge
- 4+ star rating with multiple reviews
- Active GitHub repo (if public)
...
2. Ask questions about:
   ...
   - Compatibility (e.g., database versions, Node.js version)
...
- [ ] Review tech stack - are you comfortable with these technologies?
- [ ] Check seller rating and reviews
- [ ] Read known issues list
- [ ] Verify price is acceptable
- [ ] Check what's included (full code, documentation, support?)
...
- Setup instructions (if provided by seller)
...
- During this time:
  ...
  - You can review and test the code
  - Seller does NOT receive payment yet
- After 7 days:
  - If no issues, seller receives payment automatically
  - If you opened a dispute, we review and resolve
...
- [ ] Major features work as described
- [ ] No critical bugs that prevent use
...
- ✅ Major features must work (YES)
- ✅ Completion % must be accurate (YES)
...
- Code cannot be run (missing critical files)
...
4. Provide evidence:
   ...
   - Specific description mismatches
   - Error messages
5. Submit dispute
...
- Possible outcomes:
  - **Full refund**: Description significantly mismatched
  - **Partial refund**: Minor issues but mostly as described
  - **No refund**: Project matches description, buyer error
- Decision is final
...
- Check completion % and known issues
- Message seller if you need clarification
...
3. Fill out review form:
   ...
   - **Detailed Ratings** (optional):
     ...
     - Seller Responsiveness (1-5)
     - Accuracy of Description (1-5)
   - **Anonymous Option**: Hide your username from review
4. Submit review
...
- You cannot edit or delete reviews (ensures authenticity)
- Anonymous reviews hide your name but show "Verified Purchase"
...
- **Open Dispute**: If within 7-day window
...
2. Write your message:
   ...
   - Ask about setup complexity
   - Request demo if not provided
   - Clarify completion status
3. Send message
4. Seller receives email notification
5. You receive email when seller replies
...
- Patience appreciated - sellers may have jobs/commitments
...
- Threaten bad reviews to pressure sellers
...
4. Install all dependencies (`npm install`, `pip install`, etc.)
5. Message seller with specific error messages
6. Search error messages on Google/Stack Overflow
...
- You'll need to finish development yourself
...
- Hosting requirements fit your budget
...
- Use projects as tutorials with actual code
...
- Communicate with clients about using starter code (ethical transparency)
...
- Factor finishing costs into budget (time × hourly rate)
...
- Message seller directly (if project-specific issue)

---

## Success Stories

> "Bought a 60% complete Django e-commerce project for $300. Hired a developer on Upwork to finish it for $800. Launched my store 3 weeks later. Would have cost $5,000+ to build from scratch."
> — **Maria T.**, E-commerce Entrepreneur

> "As a freelancer, I saved 40 hours on a client project by buying a React dashboard starter for $150. Client was happy with faster delivery, I made more profit. Win-win."
> — **David L.**, Freelance Developer

> "I'm learning web development. Bought 3 projects for $50-$100 each. Studying the code and finishing them has taught me more than tutorials ever did."
> — **Emma R.**, Self-Taught Developer
...
3. ✅ Ask questions before purchasing
4. ✅ Test code during 7-day escrow period
5. ✅ Communicate professionally with sellers
6. ✅ Leave honest reviews to help the community
7. ✅ Keep backups of downloaded code

**Ready to find your first project?** Browse projects at `/projects` and start building!
