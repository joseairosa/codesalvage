 ...
 *
 * IMPORTANT: NEXT_PUBLIC_* variables MUST use static process.env['...'] access
 * so Next.js can inline them into the client bundle at build time. Dynamic access
 * via helper functions (getOptionalEnvVar) breaks client-side availability because
 * webpack/turbopack cannot resolve the variable name at compile time.
 */
...
export const env = {
  ...
  EMAIL_TEST_OVERRIDE: getOptionalEnvVar('EMAIL_TEST_OVERRIDE'),
